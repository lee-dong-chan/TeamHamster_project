...
export default async () => {
  try {
    ...
    const secondcate = [
      { name: "아우터", preCateId: 1 },
      { name: "상의", preCateId: 1 },
      { name: "바지", preCateId: 1 },
      { name: "치마", preCateId: 1 },
      { name: "원피스", preCateId: 1 },
      { name: "점프슈트", preCateId: 1 },
      { name: "셋업/세트", preCateId: 1 },
      { name: "언더웨어/홈웨어", preCateId: 1 },
      { name: "테마/이벤트", preCateId: 1 },
      //
      { name: "아우터", preCateId: 2 },
      { name: "상의", preCateId: 2 },
      { name: "바지", preCateId: 2 },
      { name: "점프슈트", preCateId: 2 },
      { name: "셋업/세트", preCateId: 2 },
      {
        name: "언더웨어/홈웨어",
    ...
    const Thirdcate = [
      { name: "패딩", preCateId: 27 + 1 },
      { name: "점퍼", preCateId: 27 + 1 },
      { name: "코트", preCateId: 27 + 1 },
      { name: "자켓", preCateId: 27 + 1 },
      { name: "가디건", preCateId: 27 + 1 },
      { name: "조끼/베스트", preCateId: 27 + 1 },
      { name: "니트/스웨터", preCateId: 27 + 2 },
      { name: "후드티/후드집업", preCateId: 27 + 2 },
      { name: "맨투맨", preCateId: 27 + 2 },
      { name: "블라우스", preCateId: 27 + 2 },
      { name: "셔츠", preCateId: 27 + 2 },
      { name: "반팔 티셔츠", preCateId: 27 + 2 },
      { name: "긴팔 티셔츠", preCateId: 27 + 2 },
      { name: "민소매 티셔츠", preCateId: 27 + 2 },
      { name: "데님/청바지", preCateId: 27 + 3 },
      { name: "슬랙스", preCateId: 27 + 3 },
      { name: "면바지", preCateId: 27 + 3 },
      { name: "반바지", preCateId: 27 + 3 },
      {
        name: "트레이닝/조거팬츠",
        preCateId: 27 + 3,
      },
      { name: "레깅스", preCateId: 27 + 3 },
      { name: "기타 바지", preCateId: 27 + 3 },
      { name: "롱 스커트", preCateId: 27 + 4 },
      { name: "미디 스커트", preCateId: 27 + 4 },
      { name: "미니 스커트", preCateId: 27 + 4 },
      { name: "롱 원피스", preCateId: 27 + 5 },
      { name: "미디 원피스", preCateId: 27 + 5 },
      { name: "미니 원피스", preCateId: 27 + 5 },
      { name: "정장/셋업", preCateId: 27 + 7 },
      {
        name: "트레이닝/스웨트 셋업",

        preCateId: 27 + 7,
      },
      { name: "기타 셋업 세트", preCateId: 27 + 7 },
      { name: "홈웨어", preCateId: 27 + 8 },
      { name: "언더웨어", preCateId: 27 + 8 },
      {
        name: "코스튬/코스프레",

        preCateId: 27 + 9,
      },
      { name: "한복", preCateId: 27 + 9 },
      { name: "드레스", preCateId: 27 + 9 },
      {
        name: "기타 테마/이벤트",
      ...
      //
      { name: "패딩", preCateId: 27 + 10 },
      { name: "점퍼", preCateId: 27 + 10 },
      { name: "코트", preCateId: 27 + 10 },
      { name: "자켓", preCateId: 27 + 10 },
      { name: "가디건", preCateId: 27 + 10 },
      { name: "조끼/베스트", preCateId: 27 + 10 },
      //
      {
        name: "후드티/후드집업",
      ...
      { name: "맨투맨", preCateId: 27 + 11 },
      { name: "니트/스웨터", preCateId: 27 + 11 },
      { name: "셔츠", preCateId: 27 + 11 },
      { name: "반팔 티셔츠", preCateId: 27 + 11 },
      { name: "긴팔 티셔츠", preCateId: 27 + 11 },
      { name: "민소매 티셔츠", preCateId: 27 + 11 },
      //
      { name: "데님/청바지", preCateId: 27 + 12 },
      { name: "면바지", preCateId: 27 + 12 },
      { name: "슬랙스", preCateId: 27 + 12 },
      { name: "트레이닝/조거팬츠", preCateId: 27 + 12 },
      { name: "반바지", preCateId: 27 + 12 },
      { name: "기타바지", preCateId: 27 + 12 },
      //
      { name: "정장/셋업", preCateId: 27 + 14 },
      { name: "트레이닝/스웨트 셋업", preCateId: 27 + 14 },
      { name: "기타 셋업/세트", preCateId: 27 + 14 },
      //
      { name: "언더웨어", preCateId: 27 + 15 },
      { name: "홈웨어", preCateId: 27 + 15 },
      //
      { name: "코스튬/코스프레", preCateId: 27 + 16 },
      { name: "한복", preCateId: 27 + 16 },
      { name: "기타 테마/이벤트", preCateId: 27 + 16 },
      //
      { name: "샌들/슬리퍼", preCateId: 27 + 18 },
      { name: "구두/로퍼", preCateId: 27 + 18 },
      { name: "워커/부츠", preCateId: 27 + 18 },
      { name: "기타 남성화", preCateId: 27 + 18 },
      //
      { name: "샌들/슬리퍼", preCateId: 27 + 19 },
      { name: "구두", preCateId: 27 + 19 },
      { name: "단화/플랫슈즈", preCateId: 27 + 19 },
      { name: "워커/부츠", preCateId: 27 + 19 },
      ...
      //
      { name: "클러치백", preCateId: 27 + 21 },
      { name: "숄더백", preCateId: 27 + 21 },
      { name: "크로스백", preCateId: 27 + 21 },
      { name: "토트벡", preCateId: 27 + 21 },
      { name: "백팩", preCateId: 27 + 21 },
      { name: "기타 여성가방", preCateId: 27 + 21 },
      //
      { name: "클러치", preCateId: 27 + 22 },
      { name: "숄더백", preCateId: 27 + 22 },
      { name: "크로스백", preCateId: 27 + 22 },
      { name: "브러프케이스", preCateId: 27 + 22 },
      { name: "백팩", preCateId: 27 + 22 },
      { name: "기타 남성가방", preCateId: 27 + 22 },
      //
      { name: "캐리어", preCateId: 27 + 23 },
      { name: "기타 여행용 가방", preCateId: 27 + 23 },
      //
      { name: "프리미엄 시계(쿼츠)", preCateId: 27 + 27 },
      { name: "프리미엄 시계(오토매틱)", preCateId: 27 + 27 },
      { name: "일반 시계 시계(디지털)", preCateId: 27 + 27 },
      { name: "일반 시계(메탈 밴드)", preCateId: 27 + 27 },
      { name: "일반 시계(가죽 밴드)", preCateId: 27 + 27 },
      { name: "일반 시계(기타 밴ㄷ)", preCateId: 27 + 27 },
      //
      { name: "프리미엄 시계(쿼츠)", preCateId: 27 + 28 },
      { name: "프리미엄 시계(오토매틱)", preCateId: 27 + 28 },
      { name: "일반 시계 시계(디지털)", preCateId: 27 + 28 },
      { name: "일반 시계(메탈 밴드)", preCateId: 27 + 28 },
      { name: "일반 시계(가죽 밴드)", preCateId: 27 + 28 },
      { name: "일반 시계(기타 밴ㄷ)", preCateId: 27 + 28 },
      //
